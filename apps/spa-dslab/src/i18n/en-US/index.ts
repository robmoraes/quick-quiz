export default {
  app: {
    ...
    subtitle: 'Distributed Systems Lab quiz',
  },
  actions: {
    next: 'Next',
    startRun: 'Start run',
  ...
  devtools: {
    welcome: 'Welcome to Quick Quiz DSLab, the Distributed Systems Lab quiz',
  },
  fatalLoss: {
  ...
  errors: {
    ...
    runExpired: 'The run is no longer available. Start a new run to continue.',
    ...
    solutionRateLimited:
      'The operator found another path. Do not quit: keep exercising your lab knowledge in the quiz ;)',
  },
};
